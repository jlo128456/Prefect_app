document.addEventListener("DOMContentLoaded", async () => {
    ...
    async function showUpdateJobForm(jobId) {
        ...
        const view = currentUserRole === "admin" ? adminView : contractorView;
        ...
        document.getElementById('updateJobForm').addEventListener('submit', async (e) => {
          e.preventDefault();
          const signatureData = canvas.toDataURL(); // Convert signature to Base64
          ...
          const updatedJob = {
            ...
            signature: signatureData, // Save the signature
          };
